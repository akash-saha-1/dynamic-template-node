...
const connection = async () => {
  if (process.env.NODE_ENV == 'test') {
    ...
    mockgoose.prepareStorage().then(() =>
      mongoose
        .connect(
          'mongodb+srv://akash:12345@cluster0.hf7eb.mongodb.net/unit-testing?retryWrites=true&w=majority',
          {
        ...
        .catch((err) =>
          console.error('Error while connecting to db due to : ' + err)
        )
    );
  } else {
    mongoose
      .connect(
        'mongodb+srv://akash:12345@cluster0.hf7eb.mongodb.net/employee?retryWrites=true&w=majority',
        {
          useNewUrlparser: true,
          useUnifiedTopology: true,
        }
